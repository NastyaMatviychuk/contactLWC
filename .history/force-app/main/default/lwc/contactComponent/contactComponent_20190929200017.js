...
//------------------------------  L O A D   M O R E 
    ...
    handleChange(event){
     ...
     handleSave(event) {
        const allValid = [...this.template.querySelector('lightning-datatable')]
        ...
        fields[NAME_FIELD.fieldApiName] = this.template.querySelector("lightning-datatable.[fieldName='Name']").value;
