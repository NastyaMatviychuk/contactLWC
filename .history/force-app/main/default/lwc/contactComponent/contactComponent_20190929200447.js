...
//------------------------------  L O A D   M O R E 
    ...
    handleChange(event){
     ...
     handleSave(event) {
        const allValid = [...event.template.querySelector('lightning-datatable')]
        ...
        fields[NAME_FIELD.fieldApiName] = event.template.querySelector("lightning-datatable.[fieldName='Name']").value;
